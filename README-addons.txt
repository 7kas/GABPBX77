...
distribution of GABpbx.

    Even though GABpbx is released as open source under the terms of the
GPLv2 (see LICENSE for details), no core functionality in GABpbx has any
...
these dependencies are not compatible with dual licensing of GABpbx, the
dependant modules are set aside to make it clear that they may not be used
with commercial versions of GABpbx, unless other licensing arrangements are
