...
/*** DOCUMENTATION
	<application name="Reload" language="en_US">
		...
		<synopsis>
			Reloads an GABpbx module, blocking the channel until the reload has completed.
		</synopsis>
		<syntax>
		...
		<description>
			<para>Reloads the specified (or all) GABpbx modules and reports success or failure.
...
AST_MODULE_INFO_STANDARD_EXTENDED(GABPBX_GPL_KEY, "Reload module(s)");
