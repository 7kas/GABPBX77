...
static int transfer_exec(struct ast_channel *chan, const char *data)
{
	...
	if (ast_strlen_zero((char *)data)) {
		ast_log_chan(NULL, LOG_WARNING, "Transfer requires an argument ([Tech/]destination)\n");
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Transfers a caller to another extension");
