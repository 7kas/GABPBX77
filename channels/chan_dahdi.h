...
#ifndef _GABPBX_CHAN_DAHDI_H
#define _GABPBX_CHAN_DAHDI_H
...
struct dahdi_pvt {
	 ...
	 * from the GABpbx channel for outgoing calls.
	...
	/*! \brief TRUE if hardware Rx gain set by GABpbx */
	unsigned int hwrxgain_enabled;
	/*! \brief TRUE if hardware Tx gain set by GABpbx */
