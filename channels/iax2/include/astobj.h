...
/*! \file
 * \brief Object Model for GABpbx
 *
 * \deprecated Use astobj2.h instead
 */

#ifndef _GABPBX_ASTOBJ_H
#define _GABPBX_ASTOBJ_H
...
#define ASTOBJ_UNREF(object,destructor) \
	do { \
		...
		if (__builtin_expect((object)->refcount > 0, 1)) \
			...
			ast_log_chan(NULL, AST_LOG_WARNING, "Unreferencing unreferenced (object)!\n"); \
		ASTOBJ_UNLOCK(object); \
		if (newcount == 0) { \
