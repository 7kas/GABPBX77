...
ALTER TABLE ps_gabpbx_publications MODIFY device_state ENUM('0','1','off','on','false','true','no','yes') NULL;

ALTER TABLE ps_gabpbx_publications MODIFY mailbox_state ENUM('0','1','off','on','false','true','no','yes') NULL;
