...
CREATE TABLE ps_inbound_publications (
    id VARCHAR(40) NOT NULL, 
    endpoint VARCHAR(40), 
    "event_gabpbx-devicestate" VARCHAR(40), 
    "event_gabpbx-mwi" VARCHAR(40), 
    UNIQUE (id)
);

CREATE INDEX ps_inbound_publications_id ON ps_inbound_publications (id);

CREATE TABLE ps_gabpbx_publications (
    id VARCHAR(40) NOT NULL, 
...
CREATE INDEX ps_gabpbx_publications_id ON ps_gabpbx_publications (id);
...
ALTER TABLE ps_registrations ADD COLUMN user_agent VARCHAR(255);
...
ALTER TABLE ps_gabpbx_publications ALTER COLUMN device_state TYPE ast_bool_values USING "device_state"::text::ast_bool_values;

ALTER TABLE ps_gabpbx_publications ALTER COLUMN mailbox_state TYPE ast_bool_values USING "mailbox_state"::text::ast_bool_values;
