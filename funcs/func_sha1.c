...
/*** DOCUMENTATION
	<function name="SHA1" language="en_US">
		...
		<description>
			...
			<para>The example above sets the gabpbx variable sha1hash to the string <literal>60fa5675b9303eb62f99a9cd47f9f5837d18f9a0</literal>
		...
		char *buf, size_t len)
{
	*buf = '\0';
	...
	if (ast_strlen_zero(data)) {
		ast_log_chan(NULL, LOG_WARNING, "Syntax: SHA1(<data>) - missing argument!\n");
		return -1;
	}
