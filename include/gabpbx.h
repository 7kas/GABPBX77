 ...
 *
 * General Definitions for GABpbx top level program
 *
...
/*! \file
 * \brief GABpbx main include file. File version handling, generic pbx functions.
 */

#ifndef _GABPBX_H
#define _GABPBX_H

#include "gabpbx/autoconfig.h"
#include "gabpbx/compat.h"
#include "gabpbx/astmm.h"
...
#define AST_CURL_USER_AGENT "gabpbx-libcurl-agent/1.0"
...
int ast_set_priority(int);			/*!< Provided by gabpbx.c */
int ast_fd_init(void);				/*!< Provided by astfd.c */
int ast_pbx_init(void);				/*!< Provided by pbx.c */

/*!
 * \brief Register a function to be executed before GABpbx exits.
...
/*!
 * \since 11.9
 * \brief Register a function to be executed before GABpbx gracefully exits.
 *
 * If GABpbx is immediately shutdown (core stop now, or sending the TERM
...
/*! \brief
 * Definition of various structures that many gabpbx files need,
