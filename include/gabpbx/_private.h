...
#ifndef _GABPBX__PRIVATE_H
#define _GABPBX__PRIVATE_H

/* Load settings from gabpbx.conf, provided by options.c */
...
int ast_pj_init(void);                 /*!< Provided by libgabpbxpj.c */
