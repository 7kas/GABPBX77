...
/*! \file
 * \brief Structures for AEL - the GABpbx extension language
 *
 * \ref pbx_ael.c
 * \todo document this file (ael.h)
 */

#ifndef _GABPBX_AEL_STRUCTS_H
#define _GABPBX_AEL_STRUCTS_H

/*
 * We include gabpbx/paths.h here because it is a convenient place
