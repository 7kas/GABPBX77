...
/*! \file
 * \brief AGI Extension interfaces - GABpbx Gateway Interface
 */

#ifndef _GABPBX_AGI_H
#define _GABPBX_AGI_H
 ...
 * \param chan Pointer to an associated GABpbx channel, if any
