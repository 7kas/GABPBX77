 ...
 *        look and feel to GABpbx apps.
 */

#ifndef _GABPBX_APP_H
#define _GABPBX_APP_H
 ...
 *
 * \note This replaces the \b execvp call in all GABpbx modules
 *
 ...
 * option allows GABpbx to run a reaper loop to watch the first fork
 ...
 *
 * \note This replaces the \b system call in all GABpbx modules
 *
 ...
 *
 * Normally, GABpbx has a SIGCHLD handler that is cleaning up all zombie
 * processes from forking elsewhere in GABpbx.  However, if you want to
