...
/*! \file
 * \brief GABpbx memory management routines
 *
...
#ifndef _GABPBX_ASTMM_H
#define _GABPBX_ASTMM_H
/* IWYU pragma: private, include "gabpbx.h" */
...
/* The __ast_repl functions should not used from GABpbx sources, they are exposed
...
/*!
 * \brief Redirect standard allocators to use GABpbx functions.
 *
 * \note This option is used in some cases instead of changing the
 * existing source to use GABpbx functions.  New code should
 ...
 *
 * ast_malloc() is a wrapper for malloc() that will generate an GABpbx log
 ...
 *
 * ast_calloc() is a wrapper for calloc() that will generate an GABpbx log
 * message in the case that the allocation fails.
 *
 ...
 *
 * ast_calloc_cache() is a wrapper for calloc() that will generate an GABpbx log
 ...
 *
 * ast_realloc() is a wrapper for realloc() that will generate an GABpbx log
 * message in the case that the allocation fails.
 *
 ...
 *
 * ast_strdup() is a wrapper for strdup() that will generate an GABpbx log
 * message in the case that the allocation fails.
 *
 ...
 *
 * ast_strndup() is a wrapper for strndup() that will generate an GABpbx log
 * message in the case that the allocation fails.
 *
 ...
 *
 * ast_asprintf() is a wrapper for asprintf() that will generate an GABpbx log
 * message in the case that the allocation fails.
 *
 ...
 *
 * ast_vasprintf() is a wrapper for vasprintf() that will generate an GABpbx log
 * message in the case that the allocation fails.
 *
