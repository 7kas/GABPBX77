...
#ifndef _GABPBX_BRIDGING_CHANNEL_H
#define _GABPBX_BRIDGING_CHANNEL_H
...
/* XXX GABPBX-21271 cond is only here because of external party suspend/unsuspend support. */
	/*! Condition, used if we want to wake up a thread waiting on the bridged channel */
	ast_cond_t cond;
	/*! Current bridged channel state */
	enum bridge_channel_state state;
	/*! GABpbx channel participating in the bridge */
	struct ast_channel *chan;
	/*! GABpbx channel we are swapping with (if swapping) */
...
#endif	/* _GABPBX_BRIDGING_CHANNEL_H */
