...
#ifndef _GABPBX_CALENDAR_H
#define _GABPBX_CALENDAR_H
 ...
 * \file
 *
 * \brief A general API for managing calendar events with GABpbx
 *
 * \author Terry Wilson <twilson@digium.com>
 *
 * \note This API implements an abstraction for handling different calendaring
 * technologies in GABpbx. The services provided by the API are a dialplan
...
/*! \brief GABpbx calendar structure */
struct ast_calendar {
