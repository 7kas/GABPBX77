 ...
 *
 * \note GABpbx does not currently support SIP utf8 caller ID names or caller ID's.
 *
 * \par See also
 * 	\arg \ref callerid.c
 * 	\arg \ref callerid.h
...
#ifndef _GABPBX_CALLERID_H
#define _GABPBX_CALLERID_H
...
/*! \brief Generate Caller-ID spill from the "callerid" field of gabpbx (in e-mail address like format)
 ...
 * \param codec GABpbx codec (either AST_FORMAT_ALAW or AST_FORMAT_ULAW)
 *
 * \details
 * Acts like callerid_generate except uses an gabpbx format callerid string.
 */
