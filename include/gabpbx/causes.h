...
/*! \file
 * \brief Internal GABpbx hangup causes
 */

#ifndef _GABPBX_CAUSES_H
#define _GABPBX_CAUSES_H

/*! \page AstCauses Hangup Causes for GABpbx

The GABpbx hangup causes are delivered to the dialplan in the
 ...
 *  These are the internal cause codes used in GABpbx.
 *  \ref AstCauses
 *
 * @{
 */
