...
#ifndef _GABPBX_CCSS_H
#define _GABPBX_CCSS_H
 ...
 * case where GABpbx is acting as the NT side of an ISDN PTMP
 ...
 * due to GABpbx's knowing that the desired device is currently busy. In such a situation,
 ...
 * is that since GABpbx determined that the device was busy without actually placing a call to it,
