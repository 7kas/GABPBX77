...
#ifndef _GABPBX_CLI_H
#define _GABPBX_CLI_H
...
/*!
 * \brief Allow a CLI command to be executed while GABpbx is shutting down.
 *
 * CLI commands by defeault are disabled when GABpbx is shutting down. This is
