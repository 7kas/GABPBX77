...
#ifndef _GABPBX_CRYPTO_H
#define _GABPBX_CRYPTO_H
 ...
 * For now, GABpbx is limited to 1024 bit (128 byte) RSA keys.
 */
...
AST_OPTIONAL_API(int, ast_aes_set_encrypt_key,
	...
	{ ast_log_chan(NULL, LOG_WARNING, "AES encryption disabled. Install OpenSSL.\n"); return -1; });
