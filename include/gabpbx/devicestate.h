...
#ifndef _GABPBX_DEVICESTATE_H
#define _GABPBX_DEVICESTATE_H
 ...
 *        in GABpbx events which may be transmitted across the network to
 *        other servers.
 */
...
/*!
 * \brief Tells GABpbx the State for Device is changed
 *
