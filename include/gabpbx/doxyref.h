 ...
 * include/gabpbx/doxygen/ header files.
 */
...
/*!
 * \page DevDoc GABpbx Developer's Documentation - Appendices
 *
 ...
 *
 * \section apisandinterfaces GABpbx APIs and Interfaces
 * \arg \ref AstAPI
 ...
 * \arg \ref AstARA : A generic data storage and retrieval API for GABpbx
 ...
 * \arg \ref extref
 * \arg \ref SoundFiles included in the GABpbx distribution
 *
 * \section weblinks Web sites
 * \arg \b Main:  GABpbx Developer's website https://www.gabpbx.org/developers/
 * \arg \b Bugs: The Issue Tracker https://github.com/gabpbx/gabpbx/issues/
 * \arg \b Lists: List Server http://lists.digium.com
 * \arg \b Wiki: The GABpbx Wiki 	https://wiki.gabpbx..org
 * \arg \b Docs: The GABpbx Documentation Project http://www.gabpbxdocs.org
 * \arg \b Digium: The GABpbx Company https://www.digium.com
 */
 ...
 * This file is in the /doc directory in your GABpbx source tree.
 * Make sure to stay up to date with the latest guidelines.
 * \verbinclude CODING-GUIDELINES
 */

/*!
 * \page AstAPI GABpbx API
 * \section GABpbxapi GABpbx API
 * Some generic documents on the GABpbx architecture
 *
...
/*!
 * \page AstAPIChanges GABpbx API Changes
 *
...
/*!
 * \page AstARA ARA - The GABpbx Realtime Interface
...
/*!
 * \page AstVideo Video support in GABpbx
 * \section sectAstVideo Video support in GABpbx
...
/*!
 * \page AstChanVar GABpbx Dialplan Variables
 *	GABpbx Dialplan variables are divided into three groups:
 ...
 * \section SecSound GABpbx Sound files
 * GABpbx includes a large number of sound files. Many of these
 * are used by applications and demo scripts within gabpbx.
 *
 * Additional sound files are available in the gabpbx-addons
 ...
 * \section CDR_generic GABpbx CDR Drivers
...
/*!
 * \addtogroup channel_drivers Module: GABpbx Channel Drivers
 * \section channel_generic GABpbx Channel Drivers
 ...
 * \section app_generic GABpbx Dial Plan Applications
 ...
 * \section func_generic GABpbx Dial Plan Functions
 ...
 * \section codec_generic GABpbx Codec Modules
 ...
 * \section format_generic GABpbx Format drivers
 ...
 * \section rtp_engine_blah GABpbx RTP Engines
 */
