...
#ifndef _GABPBX_ENDPOINTS_H
#define _GABPBX_ENDPOINTS_H
 ...
 * to/from GABpbx. While this is a very useful concept for end users, it is
 * surprisingly \a not a core concept within GABpbx itself.
 *
