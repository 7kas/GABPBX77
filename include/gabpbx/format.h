 ...
 * itself using GABpbx format attributes.
 *
 * \param format to set
...
/*!
 * \brief This function is used to produce an fmtp SDP line for an GABpbx format. The
 * attributes present on the GABpbx format are translated into the SDP equivalent.
 *
