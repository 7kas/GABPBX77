...
/*! \file
 * \brief GABpbx internal frame definitions.
 * \arg For an explanation of frames, see \ref Def_Frame
 * \arg Frames are send of GABpbx channels, see \ref Def_Channel
 */

#ifndef _GABPBX_FRAME_H
#define _GABPBX_FRAME_H
 ...
 * \arg \ref Def_Channel GABpbx channels
...
enum ast_frame_type {
	...
	AST_FRAME_NULL,
	/*! Inter GABpbx Exchange private frame type */
	AST_FRAME_IAX,
...
struct ast_frame_subclass {
	...
	int integer;
	union {
		/*! The gabpbx media format */
		struct ast_format *format;
		/*! The gabpbx stream topology */
...
struct ast_control_pvt_cause_code {
	...
	int ast_cause;				/*!< GABpbx cause code associated with this message */
