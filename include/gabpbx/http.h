...
#ifndef _GABPBX_HTTP_H
#define _GABPBX_HTTP_H
 ...
 * \file
 *
 * \brief Support for Private GABpbx HTTP Servers.
 *
 * \note Note: The GABpbx HTTP servers are extremely simple and minimal and
...
/*! \brief HTTP Request methods known by GABpbx */
