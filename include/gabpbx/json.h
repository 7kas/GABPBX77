...
#ifndef _GABPBX_JSON_H
#define _GABPBX_JSON_H

#include "gabpbx/netsock2.h"

/*! \file
 *
 * \brief GABpbx JSON abstraction layer.
 * \since 12.0.0
 *
 ...
 * does, the GABpbx wrapper is always reference-stealing, and always NULL
 * safe.
 *
 ...
 *
 * \code
 *	// Example of how to use the GABpbx JSON API
...
/*!
 * \brief GABpbx's custom JSON allocator. Exposed for use by unit tests.
 * \since 12.0.0
 * \internal
 */
 ...
 * \param variables A list of GABpbx variables
