 ...
 * Clients of these routines should include "gabpbx/file.h" instead.
 */

#ifndef _GABPBX_MOD_FORMAT_H
#define _GABPBX_MOD_FORMAT_H
 ...
 * Adds a format to GABpbx's format abilities.
 * \retval 0 on success
 * \retval -1 on failure
 */
