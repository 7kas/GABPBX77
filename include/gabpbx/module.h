...
/*! \file
 * \brief GABpbx module definitions.
 *
 * This file contains the definitons for functions GABpbx modules should
...
#ifndef _GABPBX_MODULE_H
#define _GABPBX_MODULE_H
...
logos (including \"GABpbx\" or \"Digium\") without \
...
/*!
 * \brief Match modules names for the GABpbx cli.
 ...
 * \retval NULL if no matches were found or GABpbx is not yet fully booted.
 */
...
/*! \page ModMngmnt The GABpbx Module management interface
 *
...
struct ast_module_info {
	...
	/*!
	 * This holds the GABPBX_GPL_KEY, signifying that you agree to the terms of
	 * the GABpbx license as stated in the GABPBX_GPL_KEY.  Your module will not
 ...
 *                    the application
 *
 * This registers an application with GABpbx's internal application list.
 ...
 *
 * This unregisters an application from GABpbx's internal application list.
 *
 * \retval 0 success
 * \retval -1 failure
 */
