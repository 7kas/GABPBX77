...
#ifndef _GABPBX_NETSOCK2_H
#define _GABPBX_NETSOCK2_H
...
static inline int _ast_addressfamily_to_sockaddrsize(int af, const char *file, int line, const char *func)
{
	...
	default:
		ast_log_chan(NULL, __LOG_WARNING, file, line, func, "Unknown address family %d encountered.\n", af);
		return 0;
	}
}
