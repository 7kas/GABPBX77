...
#ifndef __GABPBX_OPTIONAL_API_H
#define __GABPBX_OPTIONAL_API_H

/*!
 * \file
 * \brief Optional API function macros
 *
 * Some GABpbx API functions are provided by loadable modules, thus,
...
#endif /* __GABPBX_OPTIONAL_API_H */

/*
 * Some GABpbx sources are both consumer and provider of optional API's.  The
