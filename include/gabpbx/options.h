...
/*! \file
 * \brief Options provided by main gabpbx program
 */

#ifndef _GABPBX_OPTIONS_H
#define _GABPBX_OPTIONS_H
...
/*!
 * Normal PJPROJECT active log level used by GABpbx.
 *
 * These levels are usually mapped to Error and
 * Warning GABpbx log levels which shouldn't
