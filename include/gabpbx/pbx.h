...
#ifndef _GABPBX_PBX_H
#define _GABPBX_PBX_H
...
/*!< Data structure associated with an GABpbx switch */
struct ast_switch {
 ...
 *
 * Unregisters a switch from gabpbx.
 */
 ...
 * \note AST_PBX_CALL_LIMIT refers to the maxcalls call limit in gabpbx.conf
 * \see ast_pbx_start
 */
enum ast_pbx_result {
	AST_PBX_SUCCESS = 0,
 ...
 *
 * This adds a new extension to the gabpbx extension list.
 *
 * \note It is possible for autoservice to be started and stopped on c during this
 * function call, it is important that c is not locked prior to calling this. Otherwise
 * a deadlock may occur
 ...
 *
 * This function registers a switch with the gabpbx switch architecture
 *
 * \retval 0 on success
 * \retval -1 on failure
 */
