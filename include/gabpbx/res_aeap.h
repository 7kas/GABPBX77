...
/*! \file
 * \brief GABpbx External Application Protocol API
 */
...
/*!
 * \brief Check a given protocol against that in an GABpbx external application configuration
 *
 * \param cfg A configuration object
...
/*!
 * \brief An GABpbx external application object
 *
 ...
 *
 * \param aeap An GABpbx external application object
...
/*!
 * \brief An GABpbx external application message handler
 *
...
/*!
 * \brief Supported GABpbx external application data types
 */
...
/*!
 * \brief Callbacks and other parameters used by an GABpbx external application object
 */
...
/*!
 * \brief Create an GABpbx external application object
 *
...
/*!
 * \brief Create an GABpbx external application object by sorcery id
 *
...
/*!
 * \brief Create and connect to an GABpbx external application by sorcery id
 *
 * \param id The sorcery id to lookup
 * \param params Callbacks and other parameters to use
 * \param timeout How long (in milliseconds) to attempt to connect (-1 equals infinite)
...
/*!
 * \brief Create and connect to an GABpbx external application
 *
...
/*!
 * \brief Disconnect an GABpbx external application object
 *
