...
/*! \file
 * \brief GABpbx External Application Protocol Message API
 */
...
/*!
 * \brief GABpbx external application base message
 */
struct ast_aeap_message {
...
/*!
 * \brief Create an GABpbx external application message object
 *
...
/*!
 * \brief Create an GABpbx external application request object
 *
 * \param type The type of message object to create
 * \param name The name of the message
...
/*!
 * \brief Create an GABpbx external application response object
 *
 * \param type The type of message object to create
 * \param name The name of the message
...
/*!
 * \brief Create an GABpbx external application error response object
 *
 * \param type The type of message object to create
 * \param name The name of the message
 * \param id Optional id
...
/*!
 * \brief Deserialize the given buffer into an GABpbx external application message object
 *
...
/*!
 * \brief GABpbx external application JSON message type
 */
