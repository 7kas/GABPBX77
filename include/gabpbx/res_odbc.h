...
#ifndef _GABPBX_RES_ODBC_H
#define _GABPBX_RES_ODBC_H
 ...
 * \deprecated
 *
 * This is only around for backwards-compatibility with older versions of GABpbx.
 */
