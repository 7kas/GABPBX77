...
/*! \brief Indicates the call direction respective to GABpbx */
 ...
 *
 * For the sake of brevity, a "SIP session" in GABpbx is referring to
...
struct ast_sip_session {
	...
	/*! The direction of the call respective to GABpbx */
...
struct ast_sip_session_sdp_handler {
	 ...
	 * \param sdp The entire SDP. Useful for getting "global" information, such as connections or attributes
	 * \param index The index for the session media, GABpbx stream, and PJMEDIA stream being negotiated
	 * \param gabpbx_stream The GABpbx stream representation
	...
	int (*negotiate_incoming_sdp_stream)(struct ast_sip_session *session, struct ast_sip_session_media *session_media,
		const struct pjmedia_sdp_session *sdp, int index, struct ast_stream *gabpbx_stream);
	/*!
	 ...
	 * \param index The index of the session media, SDP streams, and GABpbx streams
	 * \param gabpbx_stream The GABpbx stream representation
 ...
 * GABpbx can cope with the contents. Similarly, the SDP handler will be
