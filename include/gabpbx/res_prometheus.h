/*
 * res_prometheus: GABpbx Prometheus Metrics
 *
 ...
 * \file
 *
 * \brief GABpbx Prometheus Metrics
 *
 * This module provides the base APIs and functionality for exposing a
 * metrics route in GABpbx's HTTP server suitable for consumption by
 ...
 * and that GABpbx attempts to be a "real-time" system, we want this process
