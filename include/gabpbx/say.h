...
#ifndef _GABPBX_SAY_H
#define _GABPBX_SAY_H
...
{
	ast_log_chan(NULL, LOG_WARNING, "no implementation for the say() functions\n");
        return -1;
};
 ...
 *
 * \retval ampersand-separated string of GABpbx sound files that can be played back.
 */
