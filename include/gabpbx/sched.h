...
#ifndef _GABPBX_SCHED_H
#define _GABPBX_SCHED_H
...
#define AST_SCHED_DEL_UNREF(sched, id, refcall)			\
	do { \
		...
		if (_count == 10) { \
			ast_log_chan(NULL, LOG_WARNING, "Unable to cancel schedule ID %d.  This is probably a bug (%s: %s, line %d).\n", _id, __FILE__, __PRETTY_FUNCTION__, __LINE__); \
