...
#ifndef GABPBX_SEMAPHORE_H
#define GABPBX_SEMAPHORE_H

/*!
 * \file
 *
 * \brief GABpbx semaphore API
 *
 ...
 * blocked. Don't assume that it will give you one or the other; GABpbx has
