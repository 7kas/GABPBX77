...
#ifndef _GABPBX_STASIS_APP_H
#define _GABPBX_STASIS_APP_H
...
/*!
 * \brief Register a new Stasis application that receives all GABpbx events.
 *
 * If an application is already registered with the given name, the old
 * application is sent a 'replaced' message and unregistered.
 *
