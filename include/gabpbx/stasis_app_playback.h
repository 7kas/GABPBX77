...
#ifndef _GABPBX_STASIS_APP_PLAYBACK_H
#define _GABPBX_STASIS_APP_PLAYBACK_H
 ...
 *
 * Note that the file isn't the full path to the file. GABpbx's internal
...
#endif /* _GABPBX_STASIS_APP_PLAYBACK_H */
