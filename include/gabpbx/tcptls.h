 ...
 * \file
 *
 * \brief Generic support for tcp/tls servers in GABpbx.
 *
 ...
 * and their setup should be moved to a more central place, e.g. gabpbx.conf
...
#ifndef _GABPBX_TCPTLS_H
#define _GABPBX_TCPTLS_H

#include <pthread.h>            /* for pthread_t */
#include <sys/param.h>          /* for MAXHOSTNAMELEN */

#include "gabpbx/iostream.h"
#include "gabpbx/netsock2.h"  /* for ast_sockaddr */
#include "gabpbx/utils.h"     /* for ast_flags */

/*! SSL support */
#define AST_CERTFILE "gabpbx.pem"
