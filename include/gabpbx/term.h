...
#ifndef _GABPBX_TERM_H
#define _GABPBX_TERM_H
 ...
 * \param fgcolor Foreground color, specified as one of the constants in include/gabpbx/term.h.  Use '0' if the want the normal terminal foreground color.
 * \param bgcolor Background color, specified as one of the constants in include/gabpbx/term.h.  Use '0' if you want the normal terminal background color.
