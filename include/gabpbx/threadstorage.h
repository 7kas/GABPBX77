...
/*!
 * \page AstThreadStorage The GABpbx Thread Storage API
 *
 *
 ...
 * storage.
 *
 * The motivation for using this code in GABpbx is for situations where
 * storing data on a thread-specific basis can provide some amount of
 * performance benefit.  For example, there are some call types in GABpbx
...
#ifndef GABPBX_THREADSTORAGE_H
#define GABPBX_THREADSTORAGE_H
