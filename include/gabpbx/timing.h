...
/*!
	...
	Portions of GABpbx require a timing source, a periodic trigger
	for media handling activities. The functions in this file allow
	a loadable module to provide a timing source for GABpbx and its
	...
	The timing source used by GABpbx must provide the following
	features:
...
#ifndef _GABPBX_TIMING_H
#define _GABPBX_TIMING_H
