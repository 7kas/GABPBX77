...
#ifndef _GABPBX_UTILS_H
#define _GABPBX_UTILS_H
...
/*!
 * \brief Thread-safe gethostbyname function to use in GABpbx
 *
 * \deprecated Replaced by \c ast_sockaddr_resolve() and \c ast_sockaddr_resolve_first_af()
 * \note To be removed in GABpbx 23.
 */
 ...
 * discovery, but GABpbx does not do this.
 *
 * Because of this, UDP packets sent by GABpbx that are larger than the MTU
 ...
 * \brief Global EID
 *
 * This is set in gabpbx.conf, or determined automatically by taking the mac
...
#else
    #error "Cannot compile GABpbx: unknown and unsupported compiler."
#endif /* #if __GNUC__ */

/*!
 * \brief GABpbx wrapper around crypt(3).
 *
...
/*!
 * \brief GABpbx wrapper around crypt(3) for encrypting passwords.
 *
...
/*!
 * \brief GABpbx wrapper around crypt(3) for validating passwords.
 *
