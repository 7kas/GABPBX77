...
static int parse_config(int is_reload)
{
	...
	if (!s) {
		ast_log(LOG_WARNING, "PostgreSQL RealTime: No database user found, using 'gabpbx' as default.\n");
	...
	if (!s) {
		ast_log(LOG_WARNING, "PostgreSQL RealTime: No database password found, using 'gabpbx' as default.\n");
