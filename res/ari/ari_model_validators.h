 ...
 * pointers used to interfere with module loading. Previously, GABpbx
...
#ifndef _GABPBX_ARI_MODEL_H
#define _GABPBX_ARI_MODEL_H
...
/*!
 * \brief Validator for GABpbxInfo.
 *
 * GABpbx system information
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
...
/*!
 * \brief Function pointer to ast_ari_validate_gabpbx_info().
 */
ari_validator ast_ari_validate_gabpbx_info_fn(void);

/*!
 * \brief Validator for GABpbxPing.
 *
 * GABpbx ping information
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
...
/*!
 * \brief Function pointer to ast_ari_validate_gabpbx_ping().
 */
 ...
 *
 * Info about how GABpbx was built
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
 ...
 *
 * Info about GABpbx configuration
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
 ...
 *
 * Details of an GABpbx log channel
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
 ...
 *
 * An external device that may offer/accept calls to/from GABpbx.
 *
 ...
 *
 * A specific communication connection between GABpbx and an Endpoint.
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
 ...
 *
 * Base type for asynchronous events from GABpbx.
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
 ...
 *
 * Detailed information about a remote peer that communicates with GABpbx.
 *
 * \param json JSON object to validate.
 * \retval True (non-zero) if valid.
 * \retval False (zero) if invalid.
