...
#ifndef _GABPBX_RESOURCE_BRIDGES_H
#define _GABPBX_RESOURCE_BRIDGES_H
...
/*!
 * \brief List all active bridges in GABpbx.
 *
 ...
 *
 * This bridge persists until it has been shut down, or GABpbx has been shut down.
 *
 * \param headers HTTP headers
 * \param args Swagger parameters
 * \param[out] response HTTP response
...
#endif /* _GABPBX_RESOURCE_BRIDGES_H */
