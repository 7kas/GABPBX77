...
#ifndef _GABPBX_RESOURCE_CHANNELS_H
#define _GABPBX_RESOURCE_CHANNELS_H
...
/*!
 * \brief List all active channels in GABpbx.
 *
...
struct ast_ari_channels_hangup_args {
	/*! Channel's id */
	const char *channel_id;
	/*! The reason code for hanging up the channel for detail use. Mutually exclusive with 'reason'. See detail hangup codes at here. https://docs.gabpbx.org/Configuration/Miscellaneous/Hangup-Cause-Mappings/ */
...
#endif /* _GABPBX_RESOURCE_CHANNELS_H */
