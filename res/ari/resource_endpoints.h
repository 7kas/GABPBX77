...
#ifndef _GABPBX_RESOURCE_ENDPOINTS_H
#define _GABPBX_RESOURCE_ENDPOINTS_H
...
struct ast_ari_endpoints_refer_args {
	...
	const char *refer_to;
	/*! If true and "refer_to" refers to an GABpbx endpoint, the "refer_to" value is set to point to this GABpbx endpoint - so the referee is referred to GABpbx. Otherwise, use the contact URI associated with the endpoint. */
	int to_self;
...
#endif /* _GABPBX_RESOURCE_ENDPOINTS_H */
