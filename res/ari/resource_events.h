...
#ifndef _GABPBX_RESOURCE_EVENTS_H
#define _GABPBX_RESOURCE_EVENTS_H
...
struct ast_ari_events_event_websocket_args {
	...
	char *app_parse;
	/*! Subscribe to all GABpbx events. If provided, the applications listed will be subscribed to all events, effectively disabling the application specific subscriptions. Default is 'false'. */
	int subscribe_all;
};
...
#endif /* _GABPBX_RESOURCE_EVENTS_H */
