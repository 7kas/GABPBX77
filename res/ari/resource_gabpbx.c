...
void ast_ari_gabpbx_get_object(struct ast_variable *headers,
...
void ast_ari_gabpbx_update_object(struct ast_variable *headers, struct ast_ari_gabpbx_update_object_args *args, struct ast_ari_response *response)
{
	RAII_VAR(struct ast_sorcery *, sorcery, NULL, ast_sorcery_unref);
	RAII_VAR(struct ast_sorcery_object_type *, object_type, NULL, ao2_cleanup);
	RAII_VAR(void *, sorcery_obj, NULL, ao2_cleanup);
...
void ast_ari_gabpbx_delete_object(struct ast_variable *headers,
...
void ast_ari_gabpbx_get_info(struct ast_variable *headers,
	...
	struct ast_ari_response *response)
{
	...
	for (i = 0; i < args->only_count; ++i) {
		if (strcasecmp("build", args->only[i]) == 0) {
			...
			ast_log_chan(NULL, LOG_WARNING, "Unrecognized info section '%s'\n",
				args->only[i]);
		}
	}
...
void ast_ari_gabpbx_list_modules(struct ast_variable *headers,
...
void ast_ari_gabpbx_get_module(struct ast_variable *headers,
...
void ast_ari_gabpbx_load_module(struct ast_variable *headers,
...
void ast_ari_gabpbx_unload_module(struct ast_variable *headers,
...
void ast_ari_gabpbx_reload_module(struct ast_variable *headers,
...
void ast_ari_gabpbx_ping(struct ast_variable *headers,
...
void ast_ari_gabpbx_list_log_channels(struct ast_variable *headers,
...
void ast_ari_gabpbx_add_log(struct ast_variable *headers,
...
void ast_ari_gabpbx_rotate_log(struct ast_variable *headers,
...
void ast_ari_gabpbx_delete_log(struct ast_variable *headers,
...
void ast_ari_gabpbx_get_global_var(struct ast_variable *headers,
...
void ast_ari_gabpbx_set_global_var(struct ast_variable *headers,
