...
#ifndef GABPBX_RES_PARKING_H
#define GABPBX_RES_PARKING_H
...
enum park_call_resolution {
	...
	PARK_FORCED,		/*! The parked call was forcibly terminated by an unusual means in GABpbx */
