...
/*!
 * \brief GABpbx external application transport virtual table
 *
...
/*!
 * \brief GABpbx external application transport structure to be
...
/*!
 * \brief Create an GABpbx external application transport
 *
 * \param type The type of transport to create
 *
 * \returns An GABpbx external application transport, or NULL on error
 */
...
/*!
 * \brief Create an GABpbx external application transport, and connect it
 *
 * \param type The type of transport to create
 * \param url The URL to connect to
 * \param protocol The connection protocol to use if applicable
