...
/*! \file
 *
 * \brief file format conversion CLI command using GABpbx formats and translators
 *
...
static char *handle_cli_file_convert(struct ast_cli_entry *e, int cmd, struct ast_cli_args *a)
{
	...
	case CLI_INIT:
		...
		e->usage =
			...
			"       is not given, the default GABpbx sounds directory\n"
			"       will be used.\n\n"
			"       Example:\n"
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "File format conversion CLI command");
