...
static void g729_generate_sdp_fmtp(const struct ast_format *format, unsigned int payload, struct ast_str **str)
{
	 ...
	 * or 'no' based on the answerer (rfc7261 - 3.3). However, GABpbx being a B2BUA
	 * makes things tricky. So for now GABpbx will set annexb=no.
	 */
...
AST_MODULE_INFO(GABPBX_GPL_KEY, AST_MODFLAG_LOAD_ORDER, "G.729 Format Attribute Module",
