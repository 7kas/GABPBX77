...
static int add_supported(pjsip_tx_data *tdata)
{
	...
	/* GABpbx can send multiple "181 Call forwarded" in a single session,
...
/* GABpbx keeps track of 2 things. The redirected from address and
...
AST_MODULE_INFO(GABPBX_GPL_KEY, AST_MODFLAG_LOAD_ORDER, "PJSIP Add Diversion Header Support",
