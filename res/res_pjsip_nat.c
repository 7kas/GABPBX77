 ...
 * To address this  gabpbx uses two strategies in parallel:
 ...
 * or in the contact. Causing risk that gabpbx will update the Contact on
...
static int load_module(void)
{
	if (ast_sip_register_service(&nat_module)) {
		ast_log_chan(NULL, LOG_ERROR, "Could not register NAT module for incoming and outgoing requests\n");
...
AST_MODULE_INFO(GABPBX_GPL_KEY, AST_MODFLAG_LOAD_ORDER, "PJSIP NAT Support",
