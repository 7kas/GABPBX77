...
static int load_module(void)
{
	...
	ast_verb_chan(NULL, 3, "Security Logging Enabled\n");
...
static int unload_module(void)
{
	...
	ast_verb_chan(NULL, 3, "Security Logging Disabled\n");

	return 0;
}

AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Security Event Logging");
