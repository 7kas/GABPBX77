...
from gabpbx_processor import GABpbxProcessor
...
def main(argv):
    ...
    parser.add_argument('--source-dir', type=str, default=".",
                        help="GABpbx source directory", required=False)
    ...
    processor = GABpbxProcessor(wiki_prefix=args.docs_prefix)
    ...
    RESOURCES_TRANSFORMS = [
        Transform(rel('models.wiki.mustache'),
                  '%s/GABpbx_REST_Data_Models.md' % args.dest_dir),
