...
/* Tests for DLLists! We really should, and here is a nice place to do it in gabpbx */
...
static void dll_tests(void)
{
	...
	if (AST_DLLIST_EMPTY(&tc->entries))
		...
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_EMPTY....PROBLEM!!\n");
	...
	if (AST_DLLIST_FIRST(&tc->entries) == a)
		...
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_FIRST....PROBLEM\n");

	if (AST_DLLIST_LAST(&tc->entries) == d)
		ast_debug(1,"Test AST_DLLIST_LAST....OK\n");
	else
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_LAST....PROBLEM\n");

	if (AST_DLLIST_NEXT(a,list) == b)
		ast_debug(1,"Test AST_DLLIST_NEXT....OK\n");
	else
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_NEXT....PROBLEM\n");

	if (AST_DLLIST_PREV(d,list) == c)
		ast_debug(1,"Test AST_DLLIST_PREV....OK\n");
	else
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_PREV....PROBLEM\n");
	...
	if (AST_DLLIST_EMPTY(&tc->entries))
		...
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_REMOVE_HEAD....PROBLEM!!\n");
	...
	if (AST_DLLIST_EMPTY(&tc->entries))
		...
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_REMOVE....PROBLEM!!\n");
	...
	if (AST_DLLIST_EMPTY(&tc->entries))
		...
		ast_log_chan(NULL, LOG_ERROR,"Test AST_DLLIST_REMOVE_CURRENT... PROBLEM\n");
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Test Doubly-Linked Lists");
