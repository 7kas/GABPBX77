...
/* dummy functions to be compatible with the GABpbx core for md5.c */
...
static int manage_calls(char *host)
{
	...
	*/
	snprintf(tmp, sizeof(tmp), "GABpbx Manager at %s", host);
...
static int manager_login(char *hostname)
{
	...
	newtCenteredWindow(40, 10, "GABpbx Manager Login");
...
int main(int argc, char *argv[])
{
	...
	newtInit();
	newtCls();
	newtDrawRootText(0, 0, "GABpbx Manager (C)2002, Linux Support Services, Inc.");
	newtPushHelpLine("Welcome to the GABpbx Manager!");
