 ...
 *
 * SMS queuing application for use with gabpbx app_sms
 * by Adrian Kennard
 *
...
main (int argc, const char *argv[])
{
   ...
   const struct poptOption optionsTable[] = {
      ...
      {"spool-dir", 0, POPT_ARG_STRING | POPT_ARGFLAG_SHOW_DEFAULT, &spooldir, 0, "GABpbx spool dir", "dirname"},
