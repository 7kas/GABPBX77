 ...
 * used as a music on hold source for GABpbx.  Some devices are capable of
 ...
 * stream and dumps it straight to stdout.  Due to the way GABpbx handles
 ...
 * serviced, even if GABpbx is not currently using the source.
 *
...
int main(int argc, char *argv[])
{
	...
	if (argc != 3) {
		...
		fprintf(stderr, "Written for use with GABpbx (http://www.gabpbx.org)\n");
